...
<h3 align="center">Meta</h3>
  ...
  <p align="center">
    project_description
    <br />
    <a href="https://github.com/Continuum-AI-Inc/metalang"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/Continuum-AI-Inc/metalang">View Demo</a>
    ·
...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `Continuum-AI-Inc`, `metalang`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `Meta`, `project_description`
...
2. Clone the repo
   ```sh
   git clone https://github.com/Continuum-AI-Inc/metalang.git
   ```
...
Project Link: [https://github.com/Continuum-AI-Inc/metalang](https://github.com/Continuum-AI-Inc/metalang)
